...
#define Merchant_Key @"qIgj1i78"//9HwJ5t
#define Salt @"BSueDcI8he"//2JIfn3ez
//#define Base_URL @"https://test.payu.in"
#define Base_URL @"https://secure.payu.in"
#define Success_URL @"http://www.foodinnrestaurant.com/home"
#define Failure_URL @"http://www.foodinnrestaurant.com/home"
...
-(void)initPayment {
    ...
    NSString *amount = manger.productPrice;
    NSString *productInfo = manger.productInfo;
    NSString *firstname = manger.payeeName;

    NSString *email = [NSString stringWithFormat:@"pravin@maestrobits.com"]; // Generated a fake mail id for testing
    NSString *phone = manger.mobileNumber;
...
//    NSURLRequest *req1 = [[NSURLRequest alloc]initWithURL:[NSURL URLWithString:@"https://www.onlinesbi.com/"]];
//    
//    [self.webviewPaymentPage loadRequest:req1];
...
//        [alert show];
        ...
        [mutDictTransactionDetails setObject:manger.payeeName forKey:@"Payee_Name"];
        [mutDictTransactionDetails setObject:manger.productInfo forKey:@"Product_Info"];
        [mutDictTransactionDetails setObject:manger.productPrice forKey:@"Paid_Amount"];
...
-(void)webView:(UIWebView *)webView didFailLoadWithError:(NSError *)error {
   ...
   /*
    if (error.code == -999) {
//        [self.webviewPaymentPage loadRequest:[NSURLRequest requestWithURL:requestURL]];
            // FAILURE ALERT
            UIAlertView *alert = [[UIAlertView alloc]initWithTitle:@"Sorry !!!" message:@"Your transaction failed. Please try again!" delegate:self cancelButtonTitle:nil otherButtonTitles:@"OK", nil];
            alert.tag = 1;
            [alert show];
